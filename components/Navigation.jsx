...
const Navigation = ({active}) => {
  return (
    <nav className='box-border flex justify-center w-full gap-2 px-2 py-2 mt-4 overflow-auto overflow-y-hidden bg-gray-100 border rounded-full dark:bg-zinc-800 dark:text-white md:gap-3 md:justify-end md:px-4 '>
